        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="p-10">
            <div className="grid md:grid-cols-2 gap-10">
              {/* Left Column */}
              <div>
                <h2 className="text-2xl font-bold text-[#2D5F43] mb-6 font-['Cairo']">📞 Contact Information</h2>
              ...
              {/* Right Column */}
              <div>
                <h2 className="text-2xl font-bold text-[#2D5F43] mb-6 font-['Cairo']">⚡ Quick Actions</h2>

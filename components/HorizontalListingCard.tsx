            ...
            <div className="flex items-start justify-between gap-4 mb-3">
              <div className="flex-1">
                ...
                <div className={`flex flex-wrap items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
                  {listing.category && (
                    <span className="inline-flex items-center gap-1 px-3 py-1.5 bg-[#EBD6AF] text-[#5C3B1E] rounded-full text-sm md:text-base font-semibold shadow-sm">
                  ...
                  {listing.city && (
                    <span className="inline-flex items-center gap-1 text-[#5A4A38] text-sm md:text-base font-medium">
                      <svg className="w-4 h-4 text-[#8B5A2B]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className={`flex flex-wrap items-center gap-3 mt-auto pt-4 border-t border-[#EFDABB] ${isRTL ? 'flex-row-reverse' : ''}`}>
              ...
              {listing.phone && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#F3E1BF] text-[#2F4730] rounded-lg hover:bg-[#E6D4B0] transition-all text-sm md:text-base font-semibold shadow-sm"
                >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-2 bg-[#3B7A57] text-white rounded-lg hover:bg-[#2D5F43] transition-all text-sm md:text-base font-semibold shadow-md hover:shadow-lg ml-auto"
              >
